      ...
      <ClothUnrollEffect>
        ...
        <div className="phone:w-[90%] md:w-[70%] xl:w-[60%] xxl:w-[55%] my-10 mx-auto text-md px-6 pb-5 text-justify">
          ...
          <p className="mb-4">
            ...
            Ekarth Ventures Private Limited{" "}
            <strong>(CIN: U62099TN2024PTC169251)</strong> , having its
            registered office at{" "}
            <strong>46 College Road, Nungambakkam, Chennai, </strong>{" "}
            person(s)/entity(ies) associated/connected with it (hereinafter
            referred to as “Altern”/ “We”/”Us”/Our/”) to provide technology
            solutions for financial products and alternate opportunities. Altern
            values the trust You place in Us and recognize the importance of
            secure transactions and information privacy, and is concerned and
            committed to maintaining robust privacy protections for users
          ...
          <p className="mb-4">
            ...
            authorize Altern to contact You via email, phone call, sms or
            whatsapp and offer You Our services, imparting product knowledge and
            offer promotional offers running on the Platform for which reasons
            Your information may be collected in the manner as detailed under
            this Policy. You hereby agree that You authorize Altern to contact
            You for the above-mentioned purposes even if You have registered
            yourself under DND or DNC or NCPR service(s). Your authorization, in
            this regard, shall be valid as long as Your account is not
          ...
          <p className="mb-4">
            ...
            pertains exclusively to data collected by Altern. It does not extend
            to information disclosed to third parties through websites hosted by
            the Invoice Trading Platform. The Company reserves the right to
            amend its Privacy Policy at any time. To protect Your interests,
            please revisit this page on a regular basis to review the most
            recent version of Our Privacy Policy. By interacting with Our
            website, submitting forms, or using Our Services, You permit Us to
            use the information You provide, including any company information
          ...
          <p className="mb-4">
            When You register to become a member on Our website, We ask for
            personal information such as Your name, email address, and postal
            code (“Personal Information”). Accurate information lets Us
            personalize Our Services to meet Your needs better. In addition,
            when You interact with Our website, We may collect additional
            information such as Your IP address, operating system, and browser
            type. This information is collected to protect Your privacy and to
            compile usage statistics. (“Other Information”).
          </p>
          <p className="mb-4">
            ...
            (including transaction history) and other financial information such
            as bank account information, accounts, audit reports, profit and
            loss accounts etc.We may also take several other master data from
            you without your consent such as bureau reports, credit checks, PAN
            numbers and verification, Account Aggregator Bank account access,
            GST Details, E-Invoice details, Ecommerce or POS sales data where
            applicable, accounting information
          </p>
          <p className="mb-4">
            We may save Your account ID, access token, and other information to
            keep Your account linked to third-party integrations. However, any
          ...
          <p className="mb-4">
            ...
            “cookie” in Your computer&apos;s browser files. Cookies are data
            files that allow Your browser to communicate with the Altern
          ...
          <p className="mb-4">
            ...
            interest research on Our members using the information they supply
            upon registration to improve Our Services. We are committed to
          ...
          <p className="mb-4">
            When registering on the Application/Website, You may choose to
            provide payment information such as credit card, debit card, bank
            account details, and billing address. We prioritize the security of
            sensitive data and only use approved payment gateways that are
            digitally encrypted and provide the highest level of care available
          ...
          <p className="mb-4">
            ...
            communication purposes such as newsletters, updates, notifications,
            and other correspondence. We may also contact You by telephone to
            collect or verify the information You have provided. Any recorded
            communication will remain confidential unless required by law to be
            disclosed to governmental authorities.
          </p>

          <p className="mb-4">
            The user information will only be used for Website-related purposes
            and will not be used for additional purposes. This information will
            be retained until the termination of Your membership/listing on the
            Platform or for such other period as We deem necessary for the
            Website&apos;s operation.
          </p>
          <p className="mb-4">
            You have the right to access and update the information You
            provided. You must notify Us of any changes if the information
            provided is incomplete or inaccurate.
          </p>

          <h2 className="text-2xl font-bold mt-6 mb-2">Disclosure</h2>
          <p className="mb-4">
            We will use information only in accordance with the Policy under
            which the information was collected unless We have received explicit
            authorization.
          </p>
          ...
          <p className="mb-4">
            ...
            You with its third-party service providers for KYC purposes.
          </p>
          <p className="mb-4">
            We reserve the right to disclose any information We may have about
            You (including Your identity) if We determines that such disclosure
            ...
            Altern&apos;s rights or property, or the rights or property of Users
            of the Platform, including Altern&apos;s contributors.
          </p>
          <p className="mb-4">
            We reserve the right at all times to disclose any information
            including any Personal Information that We deem necessary to comply
            with any applicable law, regulation, legal process or governmental
            request. We also may disclose Your information when We determine
            ...
            fraud protection purposes. We shall use all reasonable efforts to
            ensure that such disclosure would be in compliance with the
            applicable laws in force in India. We would use reasonable measures
            to inform You in the event of such disclosure.
          </p>
          <p className="mb-4">
            ...
            property or personal safety of Altern, its employees, users of, or
            visitors to, the Platform, and the public. We would use reasonable
            measures to inform You in the event of such disclosure
          </p>
          <p className="mb-4">
            ...
            Aggregator data is fetched in partnership with pee dee finvest NBFC
            and You consent to pee dee finvest processing Your data.
          </p>
          <p className="mb-4">
            ...
            Partners/ POC, Income Tax details and any other information needed
          ...
          <p className="mb-4">
            ...
            and services. Altern does not share any Personal Information with
            these third-party websites or agents or advertisers. However, Altern
            reserves the right to share with You the advertisements on behalf of
            any other parties.
          </p>
          <p className="mb-4">
            Altern may provide links to other websites (&quot;Linked Site&quot;)
            on the Platform or any e-mail sent to You. However, Altern has no
            control over such websites nor is Altern affiliated to or associated
            with such third party websites unless expressly specified on the
            Platform. These Linked Sites are solely for advertisement purposes
            and Altern is not responsible for any form of transmission,
            whatsoever, received by You from any Linked Site. Accordingly,
            Altern does not make any representations concerning the privacy
            practices or policies of such third parties or terms of use of such
            websites, nor does Altern control or guarantee the accuracy,
            integrity, or quality of the information, data, text, software,
            music, sound, photographs, graphics, videos, messages or other
            materials available on such websites. Further, the inclusion or
            exclusion does not imply any endorsement by Altern of the website,
            ...
            and it is recommended that You review the privacy policy on any such
            websites prior to using such websites. Altern shall not be held
            responsible for any violation of Your privacy rights by such Linked
            Sites nor any loss, damage or injury suffered by You on account of
            action/inaction of such Linked Sites.
          </p>
          <p className="mb-4">
            Altern does not have access to or control over cookies or other
            features or technology that such Linked Sites or third party
            websites and advertisers may use to send the advertisements that
            appear on the Website directly to Your browser or to measure the
            effectiveness of their advertisements and to personalize advertising
            content. The information practices of these third-party websites and
            advertisers are not covered by this Policy. You are required to
            contact the Linked Site directly for more information about their
            privacy practices.
          </p>
          <h2 className="text-2xl font-bold mt-6 mb-2">
          ...
          <p className="mb-4">
            ...
            billing and credit information, and providing a safe and secure
            Platform for all users. Except as explicitly stated in this Privacy
            Policy, We will not share Your personal information with third
            parties.
          </p>
          <p className="mb-4">
            We appreciate Your trust in Us by providing Your personal
          ...
          <p className="mb-4">
            ...
            personal and sensitive information. In the event of a security
            breach, We will take the necessary precautions to prevent misuse and
            may attempt to notify You electronically so that You can take
            appropriate action. However, despite Our security measures, third
            parties, such as hackers, may gain unauthorized access to personal
            information. By using Our Platform, You acknowledge and agree that
            We will not be held liable for any damages resulting from such
            unauthorized access.
          </p>
          <p className="mb-4">
            ...
            misuse of Your Personal Information if such loss, damage, or misuse
            is attributable to a Force Majeure Event.
          </p>
          ...
          <p className="mb-4">
            We send email notifications to individuals who log into the Website
            as Altern Platform members. In addition, We may send You regular
            newsletters, updates, and promotional information to keep You
            updated on Platform updates.
          </p>
          ...
          <p className="mb-4">
            ...
            website&apos;s operation, or that may be important to You as a
            member of Altern.
          </p>
          ...
          <p className="mb-4">
            ...
            discretion. The updated Privacy Policy will be published on the
            Website, and there will be no separate communication. You are
            responsible for informing yourself of changes to the Privacy Policy
            by regularly checking the Website for updates. Your use of the
            Website&apos;s Services following a change in its Privacy Policy
          ...
          <p className="mb-4">
            ...
            the applicable laws in India. Courts at Chennai, India shall have
            the exclusive jurisdiction over the subject matters of this Policy.
          </p>
          <p className="mb-4">
            Any disputes relating to this Policy shall be subject to the award
            of the sole arbitrator to be appointed by the President - Chennai
            ...
            from time to time. The venue of such Arbitration shall be the city
            of Chennai, India, and the language of Arbitration shall be English.
          </p>
          ...
          <p className="mb-4">
            ...
            competent jurisdiction finds any provision of this Policy, or
            portion thereof, to be unenforceable, the invalidity or
            unenforceability of such part of this Policy shall not prejudice or
