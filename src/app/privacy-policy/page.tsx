...
export default function PrivacyPolicy() {
    return (
        <div className="p-4 max-w-7xl mx-auto">
            ...
            <p className="mb-4">
                This Platform i.e. domain name _________ including the related mobile site and mobile application is owned by Ekarth Ventures Private Limited (CIN: ____________), having its registered office at ________________, person(s)/entity(ies) associated/connected with it (hereinafter referred to as “Ethyx”/ “We”/”Us”/Our/”) to provide technology solutions for financial products and alternate opportunities. Ethyx values the trust You place in Us and recognize the importance of secure transactions and information privacy, and is concerned and committed to maintaining robust privacy protections for users (hereinafter referred to as "You" "Your" "Yourself") accessing the Platform.
            </p>
